...
const Schedule = () => (
    <div className='schedule-page'>
        ...
        <div className='schedule-items'>
            ...
            <h1 style={{ fontWeight: 'normal' }}><img src='https://icon.now.sh/pin/A7BBCE/50' alt='' />The Datathon will be virtual and a booth will be held on Rice Campus(Location: TBA)</h1>
        </div>
    </div>
)
