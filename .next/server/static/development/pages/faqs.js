...
const Faq = props => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
  className: "faq-card",
  __source: {
    fileName: _jsxFileName,
    lineNumber: 8
...
const FAQs = () => {
  ...
  for (let i = 0; i < _faqs_json__WEBPACK_IMPORTED_MODULE_4__["faqs"].length; i++) {
    qas.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Faq, {
      ...
      key: `${_faqs_json__WEBPACK_IMPORTED_MODULE_4__["faqs"][i].question.slice(0, 10)}`,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 24
      },
